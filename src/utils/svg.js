const polyfillSVG2 = require("./pathseg");
var Svg = {}

module.exports = Svg

var Bounds = require('matter-js').Bounds
var Common = require('matter-js').Common
...
;(function () {
   ...
   */
  Svg.pathToVertices = function (window, path, sampleLength) {
